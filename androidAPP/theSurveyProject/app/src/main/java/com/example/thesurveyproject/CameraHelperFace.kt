...
import com.example.thesurveyproject.log
import com.example.thesurveyproject.toast
import com.example.thesurveyproject.BitmapUtils
import com.example.thesurveyproject.AutoFitTextureView
import java.util.*
...
class CameraHelperFace(val mActivity: Activity, private val mTextureView: AutoFitTextureView) {
    ...
    private fun openCamera() {
        mCameraManager.openCamera(mCameraId, @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
